...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  #escenario { position:fixed; inset:0; display:grid; place-items:center; }
  #pista { width:1920px; height:1080px; position:relative; transform-origin:center center;
...
(function () {
  ...
  // ---- encajar diapositivas mas altas que 1080
  // Se achica el bloque de diagrama, no el texto, y con transform para que los
  // conectores (que ya estan dibujados) escalen junto con las cajas.
